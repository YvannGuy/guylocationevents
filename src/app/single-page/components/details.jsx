  ...
  const packages = [
    {
      ...
      slug: "/pack-standard",
      title: t("Pack Sonorisation Professionnelle Mac Mah AS 108 avec Housses, Supports, Mixeur Promix 8 et Câbles XLR"),
tag: t("PACK STANDARD"),
specifications: [
  { name: t("Enceintes"), value: "Mac Mah AS 108 (x2)" },
  { name: t("Type d'enceinte"), value: "Enceinte active à 2 voies (Système Bass Reflex)" },
  { name: t("Amplification"), value: "Bi-amplificateur avec amplification Class D (LF) et Class AB (HF)" },
  { name: t("Puissance RMS"), value: "200W LF + 50W HF" },
  { name: t("Puissance crête"), value: "400W LF + 100W HF" },
  { name: t("Protection"), value: "Protection contre la surchauffe, surcharge, et sous-tension" },
  { name: t("Haut-parleur"), value: "∅8\" (203 mm) pour le LF, ∅1\" (25 mm) titane pour le tweeter" },
  { name: t("Réponse en fréquence"), value: "55 Hz – 20 kHz" },
  { name: t("Dispersion"), value: "H 90° x V 60°" },
  { name: t("Connectivité Bluetooth 5.0"), value: "Streaming audio avec appairage possible de 2 enceintes" },
...
description2: t(
  "Ce pack est complet et inclut tout le nécessaire pour une utilisation facile et pratique lors de vos événements. Il comprend des housses de protection pour sécuriser vos enceintes pendant le transport et des supports robustes pour faciliter l'installation. Avec la connectivité Bluetooth 5.0, vous pouvez également diffuser votre musique sans fil, offrant ainsi plus de flexibilité pour l'organisation de vos événements."
),
subtitle: t("Ce pack tout-en-un comprend tout le nécessaire pour offrir un son de qualité supérieure lors de vos événements. Que ce soit pour une réunion intime ou un événement plus grand, ce pack répondra à vos besoins."),
informations: [
  t("Pack Complet : 2 x Mac Mah AS 108 + Housses de protection + Supports robustes"),
  t("Mixeur : Promix 8 avec contrôle de volume précis"),
  t("Connectivité : 2 x Plugger + Câble XLR 6m Easy"),
  t("Utilisation : Idéal pour des événements allant de petites réunions à des conférences")
],
    ...
    },
    {
      ...
      slug: "/pack-essentiel",
      title: t("Pack Sonorisation Professionnel Mac Mah AS 115 avec Housses, Supports, Mixeur Promix 8 et Câbles XLR"),
...
specifications: [
  ...
  { name: t("Haut-parleur"), value: "∅15\" (380 mm) pour le LF, ∅1,75\" (44 mm) titane pour le tweeter" },
...
description2: t(
  "La connectivité Bluetooth 5.0 permet de diffuser de l'audio en streaming, avec la possibilité de connecter deux enceintes pour une couverture sonore encore plus étendue. Ce pack est livré avec des housses de protection robustes et des pieds réglables pour une installation flexible. Parfait pour les événements professionnels ou privés de taille moyenne."
),
subtitle: t("Ce pack tout-en-un comprend tout le nécessaire pour offrir un son puissant et clair lors de vos événements de taille moyenne. Idéal pour des séminaires, concerts ou fêtes privées, ce pack répondra à vos besoins."),
informations: [
  t("Sonorisation parfaite pour des événements allant de 50 à 100 personnes"),
  t("Puissance et qualité sonore adaptées aux petits concerts et séminaires"),
  t("Installation facile avec housses de protection et supports ajustables"),
  t("Connectivité Bluetooth 5.0 pour un streaming audio sans fil"),
      ],
      images: [
        {
          fullImage: "/images/packstandard1.jpg",
    ...
    },
    {
      ...
      slug: "/pack-confort",
      title: t("Pack Sonorisation Professionnelle FBT X-LITE 115A avec Caisson X-SUB 118SA, Housses, Supports et Mixeur Promix 8"),
tag: t("PACK CONFORT"),
specifications: [
  { name: t("Enceintes"), value: "FBT X-LITE 115A (x2)" },
  { name: t("Caisson de basse"), value: "FBT X-SUB 118SA" },
  { name: t("Type d'enceinte"), value: "Enceinte 2 voies avec amplification numérique Class D" },
  { name: t("Puissance RMS (LF/HF)"), value: "1200W / 300W" },
  { name: t("SPL maximum"), value: "130dB" },
  { name: t("Réponse en fréquence"), value: "42Hz – 20kHz" },
  { name: t("Haut-parleur (Enceinte)"), value: "15\" (381mm), bobine de 2.5\" (63.5mm)" },
  { name: t("Tweeter"), value: "1\" (25.4mm) avec diaphragme de 1.4\" (35.6mm)" },
  { name: t("Connectivité Bluetooth 5.0"), value: "Streaming audio sans fil" },
  { name: t("Poids de chaque enceinte"), value: "19.3 kg" }
],
price: "125.00€ TTC",
unite: t("Par Jour/Week-end"),
description: t(
  "Le pack X-LITE 115A de FBT est conçu pour fournir un son clair et puissant, idéal pour des événements comme des mariages, des soirées privées ou des conférences. Ce pack comprend deux enceintes amplifiées qui diffusent le son avec précision, un caisson de basse qui ajoute de la profondeur aux basses fréquences et des housses de protection sur mesure pour faciliter le transport et garantir la sécurité de votre équipement. Avec une puissance suffisante pour couvrir de grandes salles, ce système offre une qualité sonore exceptionnelle pour vos événements."
),
description2: t(
  "Ce pack est équipé de la technologie Bluetooth 5.0, permettant de diffuser de la musique sans fil depuis votre téléphone ou un autre appareil. Il offre également un son bien réparti dans la salle, avec un niveau sonore pouvant atteindre 130 dB. Le caisson de basse FBT X-SUB 118SA renforce les basses et permet d’obtenir un son plus profond, parfait pour des événements de grande envergure. Chaque composant est protégé par des housses robustes pour assurer leur sécurité pendant le transport."
),
subtitle: t("Ce pack tout-en-un comprend tout le nécessaire pour offrir un son puissant et clair lors de vos événements de taille moyenne. Idéal pour des séminaires, concerts ou fêtes privées, ce pack répondra à vos besoins."),
informations: [
  ...
  t("Connectivité Bluetooth 5.0 pour un streaming audio sans fil de qualité professionnelle"),
  t("Caisson de basse puissant FBT X-SUB 118SA pour des basses profondes et un SPL de 136 dB")
],
      images: [
        {
          fullImage: "/images/packstandard1.jpg",
    ...
    },
    {
      ...
      slug: "/pack-premium",
      title: t("Pack Sonorisation Professionnelle FBT X-LITE 115A avec Caisson X-SUB 118SA, Mixeur Promix 16 et Câbles XLR"),
tag: t("PACK PREMIUM"),
specifications: [
  { name: t("Enceintes"), value: "FBT X-LITE 115A (x2)" },
  { name: t("Caisson de basse"), value: "FBT X-SUB 118SA" },
...
description2: t(
  "Avec la connectivité **Bluetooth 5.0**, vous pouvez diffuser de l'audio sans fil, tout en garantissant une couverture sonore exceptionnelle grâce à un SPL max de 130 dB. Le pack inclut des **câbles XLR 6m**, ainsi que des **housses de protection** pour chaque composant, assurant une sécurité pendant le transport. Ce pack est conçu pour vous offrir un son de qualité supérieure dans des événements professionnels et privés de taille moyenne à grande."
),
subtitle: t("Un pack flexible et performant pour des événements professionnels de taille moyenne à grande, offrant une sonorisation fiable et de haute qualité."),
informations: [
  t("Pack complet : 2 x FBT X-LITE 115A + FBT X-SUB 118SA + Housses de protection"),
  t("Mixeur : HPA Promix 16 avec 16 canaux et contrôle de volume précis"),
  t("Connectivité : 8 x Plugger + Câble XLR 6m Easy"),
  t("Utilisation : Idéal pour des événements allant de mariages à des conférences professionnelles"),
  t("SPL maximum : 130 dB pour une couverture sonore de qualité professionnelle"),
  t("Caisson de basse FBT X-SUB 118SA pour des basses profondes et un SPL de 136 dB")
],
    ...
    },
    {
      ...
      slug: "/pack-prestige",
      title: t("Pack Sonorisation Haut de Gamme FBT X-LITE 115A avec Caisson X-SUB 118SA, Mixeur Promix 16 et Supports Professionnels"),
tag: t("PACK PRESTIGE"),
specifications: [
  { name: t("Enceintes"), value: "FBT X-LITE 115A (x2)" },
  { name: t("Caisson de basse"), value: "FBT X-SUB 118SA" },
  ...
  { name: t("Haut-parleur (Enceinte)"), value: "15\" (381mm), bobine de 2.5\" (63.5mm)" },
  { name: t("Tweeter"), value: "1\" (25.4mm) avec diaphragme de 1.4\" (35.6mm)" },
  { name: t("Caisson de basse"), value: "18\" (457mm) avec bobine de 3\" (76.2mm)" },
  { name: t("Poids de chaque enceinte"), value: "19.3 kg" },
  { name: t("Poids du caisson de basse"), value: "34 kg" }
],
price: "175.00€ TTC",
unite: t("Par Jour/Week-end"),
description: t(
  "Le Pack Prestige FBT X-LITE 115A est conçu pour offrir une performance sonore de qualité professionnelle, adaptée aux événements les plus ambitieux. Ce pack haut de gamme inclut des enceintes puissantes **FBT X-LITE 115A**, un **caisson de basse FBT X-SUB 118SA** pour des basses profondes, et un mixeur **Promix 16** à 16 canaux pour un contrôle audio complet. Idéal pour des **concerts**, des conférences de **grande envergure** ou des événements où une gestion fine du son est essentielle."
),
description2: t(
  "Ce pack inclut également la connectivité **Bluetooth 5.0** pour une diffusion audio sans fil, ainsi que des **housses de protection** et des **supports d'enceintes BoomTone DJ SV 200 II**, assurant une installation stable et professionnelle. Le **caisson de basse** renforce la profondeur sonore, et le SPL de **130 dB** garantit une couverture optimale pour des espaces plus grands."
),
subtitle: t("Le choix ultime pour des événements professionnels. Un son puissant et un contrôle total grâce à des équipements de qualité supérieure."),
informations: [
  t("Pack complet : 2 x FBT X-LITE 115A + FBT X-SUB 118SA + Housses de protection + Supports BoomTone DJ SV 200 II"),
  t("Mixeur : HPA Promix 16 avec 16 canaux pour un contrôle complet du son"),
  t("Connectivité : 10 x Plugger + Câble XLR 6m Easy"),
  t("Utilisation : Conçu pour des événements professionnels, concerts, conférences de grande envergure"),
  t("SPL maximum : 130 dB pour une couverture sonore optimale dans des espaces vastes"),
  t("Caisson de basse FBT X-SUB 118SA pour des basses profondes et puissantes")
],
    ...
    },
    {
      ...
      title: t("Pack Sonorisation Haute Performance FBT X-LITE 115A + Mac Mah AS 115 avec Caisson X-SUB 118SA, Mixeur Promix 16 et Supports Professionnels"),
tag: t("PACK GRAND ÉVÉNEMENT"),
specifications: [
  { name: t("Enceintes"), value: "FBT X-LITE 115A (x2) + Mac Mah AS 115 (x2)" },
  { name: t("Caisson de basse"), value: "FBT X-SUB 118SA" },
  { name: t("Type d'enceinte"), value: "Enceinte 2 voies avec amplification numérique Class D" },
  { name: t("Puissance RMS (LF/HF)"), value: "1200W / 300W (X-LITE) + 400W LF + 100W HF (AS 115)" },
  { name: t("Réponse en fréquence"), value: "42Hz – 20kHz (X-LITE) + 55Hz – 20kHz (AS 115)" },
  { name: t("Haut-parleur (X-LITE)"), value: "15\" (381mm), bobine de 2.5\" (63.5mm)" },
...
unite: t("Par Jour/Week-end"),
description: t(
  "Le Pack Grand Événement est conçu pour offrir un son puissant et clair, idéal pour des événements de grande envergure comme des mariages, des concerts ou des événements en extérieur. Ce pack inclut deux enceintes FBT X-LITE 115A et deux Mac Mah AS 115, ainsi qu'un caisson de basse FBT X-SUB 118SA pour des basses profondes et enrichissantes. Avec le mixeur HPA Promix 16, vous pourrez contrôler facilement tous les sons et ajuster la musique selon vos besoins."
),
description2: t(
  "Ce pack garantit une couverture sonore parfaite pour les grands espaces. Il inclut également des housses de protection pour tous les équipements, des supports BoomTone DJ SV 200 II pour assurer une installation stable et sécurisée, ainsi que des câbles XLR 6m pour une connexion fiable. En plus, la connectivité Bluetooth 5.0 vous permet de diffuser de la musique sans fil, ajoutant encore plus de flexibilité à votre événement."
),
subtitle: t("Un pack complet pour offrir un son de qualité professionnelle lors de vos événements de grande taille."),
informations: [
  t("Pack complet : 2 x FBT X-LITE 115A + 2 x Mac Mah AS 115 + FBT X-SUB 118SA + Housses de protection + Supports BoomTone DJ SV 200 II"),
  t("Mixeur : HPA Promix 16 avec 16 canaux pour un contrôle précis du son"),
  t("Connectivité : 12 x Plugger + Câble XLR 6m Easy"),
  t("Utilisation : Parfait pour des événements extérieurs, mariages de grande ampleur, concerts et festivals"),
  t("Caisson de basse FBT X-SUB 118SA pour des basses profondes et un son puissant")
],
      images: [
        {
          fullImage: "/images/packstandard1.jpg",
