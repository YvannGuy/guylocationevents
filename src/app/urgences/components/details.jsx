...
export default function UrgenceLocation() {
  ...
  const validateForm = () => {
    ...
    if (!formData.eventType) newErrors.eventType = "Type d'événement est requis";
    if (!formData.startDateTime) newErrors.startDateTime = "Date et heure d'aller sont requises";
    if (!formData.endDateTime) newErrors.endDateTime = "Date et heure de retour sont requises";
    if (!formData.equipmentNeeded) newErrors.equipmentNeeded = "Équipement nécessaire est requis";
