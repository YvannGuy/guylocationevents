      ...
      >
        ...
        <div className="container">
          <div className="hero-content-wrap">
            <h1 className="title">{t("Urgences")}</h1>
            ...
            <p className="subtitle">
              {t(
                "Offrez une expérience visuelle immersive avec nos vidéoprojecteurs écrans sur trépied ! Parfait pour vos conférences, mariages, soirées cinéma ou présentations professionnelles"
              )}
            </p>
          </div>
        </div>
