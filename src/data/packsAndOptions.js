export const packs = [
    ...
    { id: "pack4", name: "Pack Premium", price: 13900, stripePriceId: "price_1RzjvyGKCVzDExz88H5mHpTU" },
  ...
  export const options = [
    ...
    { id: "insurance", name: "Assurance dégradation", price: 4500, icon: "🎙️", quantity: true, stripePriceId: "price_1R2JTcGKCVzDExz8ypv6QhsC" },
    { id: "delivery", name: "Livraison installation et reprise", price: 18000, icon: "🎙️", quantity: true, stripePriceId: "price_1R2JUiGKCVzDExz8MHwVjX1Q" },
    { id: "delivery-premium", name: "Livraison premium", price: 25000, icon: "🎙️", quantity: true, stripePriceId: "price_1R2JVcGKCVzDExz87KpLBl1L" },
    { id: "graphic-design", name: "Graphiste dédié", price: 4500, icon: "🎙️", quantity: true, stripePriceId: "price_1R2JWtGKCVzDExz8g5kQZdap" },
  ];