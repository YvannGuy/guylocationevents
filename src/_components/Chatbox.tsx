...
import { Box, Button, Paper, Typography, Grow, IconButton, TextareaAutosize } from '@mui/material';
...
export default function ChatBox() {
    ...
    const sendMessage = async (text: string) => {
        ...
        try {
            ...
            setMessages(prev => [
                ...prev,
                { sender: 'bot', text: "Service temporairement indisponible - Veuillez réessayer" },
            ]);
        } finally {
            setIsLoading(false);
        }
            ...
            <Grow in={open}>
                ...
                >
                    ...
                    >
                        ...
                        <IconButton
                            onClick={toggleChat}
                            sx={{ color: 'white', '&:hover': { bgcolor: orangePalette.dark } }}
                        >
                            <Close />
                        </IconButton>
                    </Box>
                        ...
                        {messages.map((msg, i) => (
                            <Box
                                ...
                                sx={{
                                    ...
                                    p: 2,
                                    borderRadius: 4,
                                    bgcolor: msg.sender === 'user' ? orangePalette.main : 'grey.100',
